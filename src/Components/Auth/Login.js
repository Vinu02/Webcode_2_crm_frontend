        ...
        <div>
            <div className='bg-light sticky-top'>
                <div className=' sticky-top bg-light'>
                    <div className='navbar container'>
                        <img src='https://repathsolutions.com/wp-content/uploads/2020/09/zoho-crm.png' style={{ width: "50px", borderRadius: "5px" }}></img>
                        <div>
            ...
            <div className='d-flex justify-content-center'>
                <form className='col-lg-3 container auth ' onSubmit={formik.handleSubmit}>
                    ...
                    <input name='Email' placeholder='Email' className='form-control mb-5' onChange={formik.handleChange} value={formik.values.Email}></input> <br/>
                    ...
                    <div class="d-grid gap-2 mt-2 text-center">
                        <button class="edit_btn" type="submit">Login</button><br/>
